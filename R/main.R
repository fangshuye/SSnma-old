...
#' when planning a new two-arm trial with binary outcome.
#' 
...
#' @export
#' @examples
#' sss_nma(p1 = 0.2, p2 = 0.3, enma_sigma = 0.4, power = 0.8)

sss_nma <- function(p1,p2,enma_sigma = NULL,power.level,sig.level = 0.05, method = "with", allocation = "uneven"){
